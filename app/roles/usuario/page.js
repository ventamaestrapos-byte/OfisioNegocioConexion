export default function PanelCliente() {
  return (
    <main style={fondo}>
      <div style={tarjeta}>
        <h1 style={titulo}>Usuario Cliente</h1>
        <p style={subtitulo}>
          Explora oficios, negocios y busca ayuda rápidamente, con la seguridad
          de ver reseñas y calificaciones reales.
        </p>

        <a href="/conexion" style={botonOro}>
          Buscar oficios cerca de mí
        </a>

        <a href="/conexion" style={botonNegro}>
          Ver negocios afiliados
        </a>

        <p style={nota}>
          Todo en un solo lugar, con profesionales verificados y negocios de
          confianza.
        </p>
      </div>
    </main>
